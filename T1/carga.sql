...
-- - dados/labbd2026/ é o caminho local onde os arquivos estão armazenados (ajustar conforme necessário)

-- Carregar dados da Fórmula 1 (F1) para staging
\copy stg_circuits              FROM 'dados/labbd2026/circuits.csv'                 WITH (FORMAT csv, HEADER true, ENCODING 'LATIN1')
\copy stg_constructors          FROM 'dados/labbd2026/constructors.csv'             WITH (FORMAT csv, HEADER true)
\copy stg_drivers               FROM 'dados/labbd2026/drivers.csv'                  WITH (FORMAT csv, HEADER true)
\copy stg_races                 FROM 'dados/labbd2026/races.csv'                    WITH (FORMAT csv, HEADER true)
\copy stg_driver_standings      (season, round, driver_id, position, points, wins)      FROM 'dados/labbd2026/driver_standings.csv'      WITH (FORMAT csv, HEADER true)
\copy stg_constructor_standings (season, round, constructor_id, position, points, wins) FROM 'dados/labbd2026/constructor_standings.csv' WITH (FORMAT csv, HEADER true)
\copy stg_results               FROM 'dados/labbd2026/results.csv'                  WITH (FORMAT csv, HEADER true)
\copy stg_qualifying            FROM 'dados/labbd2026/qualifying.csv'               WITH (FORMAT csv, HEADER true)

-- Carregar dados geográficos complementares para staging
\copy stg_airports              FROM 'dados/labbd2026/airports.csv'                 WITH (FORMAT csv, HEADER true)
\copy stg_countries             FROM 'dados/labbd2026/countries.csv'                WITH (FORMAT csv, HEADER true)
\copy stg_time_zones            FROM 'dados/labbd2026/timeZones.tsv'                WITH (FORMAT csv, HEADER true, DELIMITER E'\t')
\copy stg_feature_codes         FROM 'dados/labbd2026/featureCodes_en.tsv'          WITH (FORMAT csv, HEADER false, DELIMITER E'\t')
\copy stg_iso_language_codes    FROM 'dados/labbd2026/iso-languagecodes.tsv'        WITH (FORMAT csv, HEADER true, DELIMITER E'\t')
\copy stg_cities                FROM 'dados/labbd2026/cities15000.tsv'              WITH (FORMAT csv, HEADER false, DELIMITER E'\t')
-- ============================================================================================================
